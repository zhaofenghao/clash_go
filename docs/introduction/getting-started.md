...
You can download Clash core binaries here: [https://github.com/zhaofenghao/clash_go/releases](https://github.com/zhaofenghao/clash_go/releases)
...
For other build targets, check out the [Makefile](https://github.com/zhaofenghao/clash_go/blob/master/Makefile).
