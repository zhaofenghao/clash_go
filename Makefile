...
GOBUILD=CGO_ENABLED=0 go build -trimpath -ldflags '-X "github.com/zhaofenghao/clash_go/constant.Version=$(VERSION)" \
		-X "github.com/zhaofenghao/clash_go/constant.BuildTime=$(BUILDTIME)" \
		-w -s -buildid='
